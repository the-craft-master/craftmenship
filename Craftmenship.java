...
public class Craftmenship {
    ...
    private void initGL() {
        ...
        glLight(GL_LIGHT0, GL_POSITION, lightPosition2); //sets our light’s position
        glLight(GL_LIGHT0, GL_SPECULAR, whiteLight2);    //sets our specular light
        glLight(GL_LIGHT0, GL_DIFFUSE, whiteLight2);     //sets our diffuse light
        glLight(GL_LIGHT0, GL_AMBIENT, whiteLight2);     //sets our ambient light
    ...
    private void initLightArrays(){
        ...
        lightPosition1.put(100.0f).put(0.0f).put(0.0f).put(1.0f).flip();
        whiteLight1 = BufferUtils.createFloatBuffer(4);
        whiteLight1.put(4.0f).put(4.0f).put(4.0f).put(0.0f).flip();
        
        lightPosition2 = BufferUtils.createFloatBuffer(4);
        lightPosition2.put(0.0f).put(00.0f).put(100.0f).put(1.0f).flip();
        whiteLight2 = BufferUtils.createFloatBuffer(4);
        whiteLight2.put(1.0f).put(1.0f).put(1.0f).put(0.0f).flip();
    }
}
